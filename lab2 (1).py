...
print len(concepts)
print prior.reshape(len(concepts)).shape

x = np.arange(0, len(concepts), 1)
...
fig, ax_lst = plt.subplots(3, 1, figsize=(40, 100))

y = prior.reshape(len(concepts))

ax_lst[0].barh(concepts, y)
ax_lst[0].set_xlabel("prior", fontsize=24)
ax_lst[0].set_ylabel("concepts", fontsize=24)
ax_lst[0].grid(True)

ax_lst[1].barh(concepts, likelihood)
ax_lst[1].set_xlabel("likelihood", fontsize=24)
ax_lst[1].grid(True)

ax_lst[2].barh(concepts, posterior)
ax_lst[2].set_xlabel("posterior", fontsize=24)
ax_lst[2].grid(True)
...
plt.title('Predictive Probability', fontsize=24)

plt.ylabel('Probability', fontsize=24)
plt.xlabel('Predicted Number', fontsize=24)
